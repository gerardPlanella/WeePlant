...
int sendHumidity(WiFiClient, int);
int16_t readADC();
int adc2hum(int16_t);
...
int sendImage(WiFiClient client, camera_fb_t * fb){
  ...
  sprintf(msg, "[IMAGE:%d]", (int)fb->len);
...
int sendHumidity(WiFiClient client, int hum){
  int ok = 0;
  char msg[100];
...
/*
int adc2hum(int16_t adc){
  //TODO: Conversion to humidity values from ADC
}
*/
